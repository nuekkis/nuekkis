    ...
    <tr>
      ...
      <td width="50%">
        ...
        ">
          ...
          <p style="text-align: center; color: #333;">
            Terminal, bash veya shell kullanmadan NPM kütüphaneleri kodlayabilmenize, indirebilmenize, yayımlayabilmenize ve daha fazlasını yapabilmenize olanak sağlayan web aracı.
          </p>
        </div>
      </td>
    </tr>
