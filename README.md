...
<div align="center">
  ...
  <br/>
  <p>
    <img src="https://skillicons.dev/icons?i=html,css,js,ts,py,cs,rust,react,tailwind,nextjs,vite,astro,electron,tauri,nodejs,express,nestjs,graphql,supabase,mongodb,postgres,mysql,sqlite,redis,prisma,docker,kubernetes,nginx,git,github,githubactions,linux,aws,gcp,azure,postman,regex,jest,vscode,idea,vercel,figma,bun,codepen,cloudflare" />
  </p>
</div>
